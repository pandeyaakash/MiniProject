...
<main id="top" class="masthead" role="main">
  <center> <h1> Select an Option </h1>
    ...
    <div style="width:25%;float:left;">
      ...
      <div align = "center"> <a href="addnotice.php"> <img src="images/notice.png" alt="Add Notices">
        <div class="caption">
          <h2>Add</h2>
		  <p>Notices</p>
		</div>
    ...
    <div style="width:25%;float:left;">
      ...
      <div align = "center"> <a href="adddoc.php"> <img src="images/doc.png" alt="Add Documents">
        <div class="caption">
          <h2>Add</h2>
		  <p>Documents</p>
		</div>
    ...
    <div style="width:25%;float:left;">
      ...
      <div align = "center"> <a href="addevent.php"> <img src="images/event.png" alt="Add Events">
        <div class="caption">
          <h2>Add</h2>
		  <p>Events</p>
		</div>
	...
	<div style="width:25%;float:left;">
      ...
      <div align = "center"> <a href="adduser.php"> <img src="images/useradd.png" alt="Add User">
        <div class="caption">
          <h2>Add</h2>
		  <p>Users</p>
		</div>
