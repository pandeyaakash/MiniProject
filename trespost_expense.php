...
<main id="top" class="masthead" role="main">
  <center> <h1> Expense Management! </h1>
    </div>   
  </div>
</main>
...
<div> <br> 
<div style="width:100%;float:left;"class="col-sm-6 col-md-3">
      <div class="thumbnail"> <a href="addexpense.php"> <img src="images/addch.png" alt="analytics-icon">
        <div class="caption">
          <h3>Add Expense</h3>
          <p>Add expenses to the database </p>
        </div>
      </div>
    </div>
