...
$data .="<caption>USERS</caaption>";
$data .="<thead>";
$data .="<tr align='center'>";
$data .="<th><h3>USERNAME</h3></th>";
$data .="<th><h3>FLAT NO.</h3></th>";
$data .="<th><h3>CONTACT NO.</h3></th>";
$data .="</tr>";
$data .="</thead>";
$data .="<tbody>";
...
try{
	...
	foreach($cursor as $document){
		...
		$data .="<td>".$document["flatno"]."</td>";
		$data .="<td>".$document["contact no"]."</td>";
		$data .="</tr>";
