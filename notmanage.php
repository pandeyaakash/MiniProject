...
<div> <br> 
<div style="width:50%;align:left;" class="col-sm-6 col-md-3">
      <div class="thumbnail"> <a href="addnotice.php"> <img src="images/addch.png" alt="analytics-icon">
        <div class="caption">
          <h3>Add New Notices</h3>
          <p>Add a new notice to the society! </p>
        </div>
      </div>
    </div>
    ...
    <div style="width:50%;align:left;" class="col-sm-6 col-md-3">
      <div class="thumbnail"> <a href="notmanage.php"><img src="images/minus.png" alt="analytics-icon">
        <div class="caption">
          <h3>Delete Notice</h3>
          <p>Delete notices from the society! </p>
        </div>
      </div>
    </div>
    </div>
