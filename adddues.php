...
<script>
function validate(){
	if(document.adddues.Ammount.value==""){
		alert("Ammount cannot be left blank");
		document.adddues.Ammount.focus();
		return false;
	}
	if(document.adddues.Spent.value==""){
		alert("Spent On field cannot be blank");
		document.adddues.Spent.focus();
		return false;
	}
	var inputdate= new Date(document.adddues.Date.value);
	var today= new Date();
	if(inputdate.setHours(0,0,0,0)<today.setHours(0,0,0,0){
		alert("Enter a Valid Date");
		document.adddues.Date.focus();
		return false;
	}
}
</script>
...
<form name="adddues" action="add_dues.php" onsubmit="return validate()" method="GET">
