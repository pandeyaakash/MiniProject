...
function validateForm(){
	if(document.adddoc.Subject.value==""){
		alert("Please Enter Subject");
		document.adddoc.Subject.focus();
		return false;
	}
	if(document.adddoc.Purpose.value==""){
		alert("Please enter the content of document");
		document.adddoc.Purpose.focus();
		return false;
	}
	var inputdate= new Date(document.adddoc.Date.value);
	var today= new Date();
	if(inputdate.setHours(0,0,0,0)<today.setHours(0,0,0,0)){
		alert("Enter a Valid Date");
		document.adddoc.Date.focus();
		return false;
	}
...
<form name="adddoc" action="add_doc.php" onsubmit="return validateForm()" method="GET">
...
<td><textarea cols="50" rows="20" name="Purpose" required="required"></textarea></td>
</tr>
